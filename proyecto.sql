...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2021 a las 22:33:54
...
CREATE TABLE `lugares` (
  ...
  `nombrecomercial` varchar(100) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `lugares` (`id_lugar`, `departamento_lugar`, `municipio_lugar`, `nombrecomercial`, `tipo_lugar`, `direccion_lugar`, `telefono_lugar`) VALUES
(1, 'Quindío', 'Armenia', 'Centenario Trampoline Park', 'Actividades de parques de atracciones y parques temáticos', ' AVENIDA CENTENARIO CL 4, ARMENIA, QUINDIO', '3168337752'),
(2, 'Quindio', 'Armenia', 'Centenario Trampoline Park', 'Restaurante', 'Manzana G #56 - Ciudad Dorada', '3245678579'),
(3, 'Quindio', 'Armenia', 'Kakis', 'Restaurante', 'Mazana G #56 - Ciudad divina', '3245576898'),
(4, 'Quindio', 'Armenia', 'La Antorcha', 'Restaurante', 'Avenida Centenario', '3167896543'),
(5, 'vfdbvcf', 'fdbfd', 'gdg', 'gdgd', 'gdg', '546'),
(6, 'vfdbvcf', 'fdbfd', 'gdg', 'gdgd', 'gdg', '546'),
(7, 'fg', 'f', 'ffg', 'hfgh', 'gfh', '5657567'),
(8, 'fg', 'f', 'ffg', 'hfgh', 'gfh', '5657567'),
(9, 'fg', 'f', 'ffg', 'hfgh', 'gfh', '5657567');
...
--
ALTER TABLE `lugares`
  MODIFY `id_lugar` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
