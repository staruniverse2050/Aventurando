...
<title>Registro Patrocinadores</title>
...
<body>
    <div class="cabeza">
		<ul class="menu">
			<li class="submenu"> <a class="link" href="#"></a><A HREF="Registro Lugares.html">Patrocinadores </A></button>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
                        <h1>REGISTRO <b>PATROCINADORES</b></h1>
                    </div>
                    <div class="col-sm-7">
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
						...
						<td>Armenia</td>
						<td>La Antorcha</td>
						<td>Restaurante-Cafè-Bar</td>
                        <td>Comidas y bebidas</td>
                        <td>cafelaantorcha@gmail.com</td>
                        <td>Av.Centenario #44 Norte-04</td>
                        <td>3218675400</td>
                        <td>
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form>
				<div class="modal-header">						
					<h4 class="modal-title">Agregar nuevo patrocinador</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</div>
				<div class="modal-body">					
